...
HimalayaAir is a Kathmandu Valley air-quality intelligence platform built for provenance-aware, fallback-safe operation.

## Architecture Overview

- Ingestion: OpenAQ observed sensors + Open-Meteo modeled baseline + replay fixtures.
...
- UI: React dashboard with explicit source mode and confidence signaling.

```mermaid
flowchart LR
  OA[OpenAQ sensors] --> K[(Kafka)]
  OM[Open-Meteo modeled AQ/weather] --> K
...
## Source Modes and Observation Types
...
3. Optional streaming path for replay/bench tests:
...
- `docs/screenshots/provenance-panel.png`
- `docs/screenshots/replay-demo-mode.png`
...
- Public OpenAQ freshness can be sparse; system correctly degrades through approved modes instead of inventing live data.
- Replay fixture currently provides deterministic demo seeding, while richer DB-window replay selection remains future operational work.

## Additional Docs

- System source-of-truth: `docs/himalayaair-system-overview.md`
- Phase workflow source-of-truth: `docs/codex/PHASE_INDEX.md`
